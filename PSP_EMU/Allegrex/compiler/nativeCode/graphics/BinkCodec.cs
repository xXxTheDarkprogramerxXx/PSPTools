...
namespace pspsharp.Allegrex.compiler.nativeCode.graphics
{
	...
	/// 
	/// </summary>
	public class BinkCodec : AbstractNativeCodeSequence
	{
...
//ORIGINAL LINE: final short[] block = new short[64];
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final int[] context = new int[64];
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final int[] temp = new int[64];
			int[] temp = new int[64];
			for (int i = 0; i < 8; i++)
			{
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final int[] src = new int[8];
			int[] src = new int[8];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final int[] dst = new int[8];
			int[] dst = new int[8];
