...
namespace pspsharp.format
{
	...
	using SceFontInfoBW = pspsharp.HLE.kernel.types.SceFontInfoBW;
...
//ORIGINAL LINE: public BWFont(ByteBuffer f, String fileName) throws java.io.IOException
		...
		public virtual int[] CharmapCompressed
		{
			get
			{
		...
		public override SceFontInfo createFontInfo()
		{
