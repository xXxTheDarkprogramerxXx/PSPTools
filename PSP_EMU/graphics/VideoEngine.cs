...
//ORIGINAL LINE: final boolean needToDiscardVertices = !context.vinfo.transform2D && !re.canDiscardVertices();
...
//ORIGINAL LINE: log(String.format("sprite discarded %b, %b", discarded1, discarded2));
		...
		private void exportCommandPRIM(int numberOfVertex, int type)
		{
			...
			Memory mem = Memory.Instance;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final float[] position = new float[4];
			float[] position = new float[4];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final float[] modelViewMatrix = new float[4 * 4];
			float[] modelViewMatrix = new float[4 * 4];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final float[] vertexPosition = new float[4];
			float[] vertexPosition = new float[4];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final float[] normalizedN = new float[3];
			float[] normalizedN = new float[3];
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final VertexState transformedV = new VertexState();
...
//ORIGINAL LINE: public static String getPsmName(final int psm)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not available in .NET:
//ORIGINAL LINE: public static String getLOpName(final int ops)
	...
	//JAVA TO C# CONVERTER TODO TASK: The following line has a Java format specifier which cannot be directly translated to .NET:
	//ORIGINAL LINE: log.info(String.format("Using DoubleTexture2DCoords %b", value));
