...
//ORIGINAL LINE: public static void qmfDeintNeg(float v[], int vOffset, final float src[], int srcOffset)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not available in .NET:
//ORIGINAL LINE: public static void qmfDeintBfly(float v[], int vOffset, final float src0[], int src0Offset, final float src1[], int src1Offset)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not available in .NET:
//ORIGINAL LINE: public static void hf_gen(float X_high[][], int XhighOffset, final float X_low[][], int XlowOffset, final float alpha0[], final float alpha1[], float bw, int start, int end)
...
//ORIGINAL LINE: final float alpha[] = new float[4];
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not available in .NET:
//ORIGINAL LINE: public static void hfGFilt(float Y[][], int Yoffset, final float Xhigh[][][], int Xoffset, final float gFilt[], int mMax, int ixh)
