...
//	import static Math.Sqrt;
	...
	public class FFT
	{
		...
		/// <summary>
		/// Compute inverse MDCT of size N = 2^nbits </summary>
		/// <param name="output"> N samples </param>
		/// <param name="input"> N/2 samples </param>
		...
		/// thus excluding the parts that can be derived by symmetry </summary>
		/// <param name="output"> N/2 samples </param>
		/// <param name="input"> N/2 samples </param>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not available in .NET:
//ORIGINAL LINE: public void imdctHalf(float[] output, int outputOffset, final float[] input, int inputOffset)
...
//ORIGINAL LINE: final float[] r = new float[4];
			float[] r = new float[4];
			for (int k = 0; k < n8; k++)
			{
		...
		/// <summary>
		/// Compute MDCT of size N = 2^nbits </summary>
		/// <param name="input"> N samples </param>
		/// <param name="out"> N/2 samples </param>
