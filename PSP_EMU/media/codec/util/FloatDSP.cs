...
//ORIGINAL LINE: public static void vectorFmul(float[] dst, int dstOffset, final float[] src0, int src0Offset, final float[] src1, int src1Offset, int len)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not available in .NET:
//ORIGINAL LINE: public static void vectorFmacScalar(float[] dst, int dstOffset, final float[] src, int srcOffset, float mul, int len)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not available in .NET:
//ORIGINAL LINE: public static void vectorFmulScalar(float[] dst, int dstOffset, final float[] src, int srcOffset, float mul, int len)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not available in .NET:
//ORIGINAL LINE: public static void vectorDmulScalar(double[] dst, int dstOffset, final double[] src, int srcOffset, double mul, int len)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not available in .NET:
//ORIGINAL LINE: public static void vectorFmulWindow(float[] dst, int dstOffset, final float[] src0, int src0Offset, final float[] src1, int src1Offset, final float[] win, int winOffset, int len)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not available in .NET:
//ORIGINAL LINE: public static void vectorFmulAdd(float[] dst, int dstOffset, final float[] src0, int src0Offset, final float[] src1, int src1Offset, final float[] src2, int src2Offset, int len)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are not available in .NET:
//ORIGINAL LINE: public static void vectorFmulReverse(float[] dst, int dstOffset, final float[] src0, int src0Offset, final float[] src1, int src1Offset, int len)
