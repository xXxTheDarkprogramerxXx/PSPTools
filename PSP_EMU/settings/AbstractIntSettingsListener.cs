...
namespace pspsharp.settings
{
	...
	/// 
	/// </summary>
	public class AbstractIntSettingsListener : AbstractStringSettingsListener
	{
		/* (non-Javadoc)
		...
		protected internal virtual void settingsValueChanged(string option, int value)
		{
		...
		/// </summary>
		/// <param name="value">     the new option value </param>
		protected internal virtual void settingsValueChanged(int value)
		{
		}
	}
