...
namespace PSP_Tools.Impl.Alsa
{
    ...
    public static unsafe class Alsa
    {
        ...
        */
        ...
        [DllImport(Dll)]
        internal static extern int snd_pcm_hw_params_set_access(IntPtr playback_handle, IntPtr hw_params,
            snd_pcm_access snd_pcm_access);
        ...
        [DllImport(Dll)]
        internal static extern int snd_pcm_hw_params_set_rate_near(IntPtr playback_handle, IntPtr hw_params, int* val,
            void* dir);
        ...
        /// <returns>0, otherwise a negative error code if configuration space would become empty</returns>
        [DllImport(Dll)]
        internal static extern int snd_pcm_hw_params_set_periods(IntPtr playback_handle, IntPtr hw_params, int periods,
            int dir);
        ...
        /// <returns></returns>
        [DllImport(Dll)]
        internal static extern int snd_pcm_hw_params_set_buffer_time_near(IntPtr playback_handle, IntPtr hw_params,
            int* val, int* dir);
        ...
        /// <returns></returns>
        [DllImport(Dll)]
        internal static extern int snd_pcm_hw_params_set_period_time_near(IntPtr playback_handle, IntPtr hw_params,
            int* val, int* dir);
        ...
        /// <returns></returns>
        [DllImport(Dll)]
        internal static extern int snd_pcm_hw_params_set_period_size(IntPtr playback_handle, IntPtr hw_params, int val,
            int* dir);
    }
}